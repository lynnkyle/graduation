...
# 创新点
parser.add_argument('--fusion', default='Transformer', type=str)
...
for epoch in range(args.num_epoch):
    ...
    lr_scheduler.step()
    logger.info(f'Epoch {epoch + 311}/{args.num_epoch}, Loss: {loss:.4f}')
    if (epoch + 1) % args.valid_epoch == 0:
        ...
        if mrr > best_mrr:
            ...
            torch.save({'state_dict': model.state_dict(), 'optimizer': optimizer.state_dict(),
                        'scheduler': lr_scheduler.state_dict()}, f'ckpt/{args.model}/{args.data}/{epoch + 310}.ckpt')
